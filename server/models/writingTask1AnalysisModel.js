...
const writingTask1AnalysisVisualAssetSchema = new mongoose.Schema(
  {
    imageId: {
      type: String,
      trim: true,
...
const writingTask1AnalysisSchema = new mongoose.Schema(
  {
    studentUserId: {
      type: String,
      trim: true,
    ...
    visualAsset: {
      type: writingTask1AnalysisVisualAssetSchema,
      default: () => ({
        imageId: "",
        url: "",
      }),
    ...
    criteriaFeedback: {
      taskAchievement: { type: String, trim: true, default: "" },
  ...
  {
    timestamps: true,
    collection: "writing_task1_analyses",
  },
);

writingTask1AnalysisSchema.index(
  { studentUserId: 1, taskRefId: 1, submittedAt: -1 },
  { name: "student_writing_task1_analyses_lookup" },
);

module.exports = mongoose.model("WritingTask1Analysis", writingTask1AnalysisSchema);
