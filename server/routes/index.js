...
const writingTask2Routes = require("./writingTask2Routes");
const writingTask1Routes = require("./writingTask1Routes");
...
router.use("/writing-task2", writingTask2Routes);
router.use("/writing-task1", writingTask1Routes);
