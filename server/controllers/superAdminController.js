...
function buildReadingBlockExtractionPrompt() {
  return [
    ...
    "- tokenize blanks with gap objects",
    "",
    "passageScope rules:",
    "- If block refers to whole passage:",
    '{ "type":"full_passage", "targets": null }',
    "",
    "- If paragraph letters are explicitly referenced:",
    '{ "type":"paragraphs", "targets":["A","B"] }',
    "",
